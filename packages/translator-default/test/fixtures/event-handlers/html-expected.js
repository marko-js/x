  ...
  function(input, out, _component, component, state) {
    out.w(
      `<div${_marko_attr(
        ...
        "data-marko",
        {
          "onDashed-cased-Event": _component.d(
            "Dashed-cased-Event",
            "handle",
            false
          )
        ...
        false
      )}></div><div onmouseout="someStringHandler"${_marko_attr(
        "data-marko",
        {
    ...
    _customTag_tag({}, out, _component, "3", [
      ["thing", "handleThing", false, [a, b, ...d]]
    ]);

    _customTag_tag({}, out, _component, "4", [
      ["Dashed-cased-Event", "handle", false]
    ]);

    _customTag_tag({}, out, _component, "5", [
      ["camelcasedEvent", "handle", false]
    ]);
  },
  {
