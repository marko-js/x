...
const _message$OtherBody = _contextClosure("packages/translator/src/__tests__/fixtures/context-tag-from-relative-path/other.marko", [], (_scope, message) => _data(_scope[0], message));
