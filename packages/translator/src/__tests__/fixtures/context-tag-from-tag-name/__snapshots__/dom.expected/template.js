...
const _message$otherBody = _contextClosure("packages/translator/src/__tests__/fixtures/context-tag-from-tag-name/components/other.marko", [], (_scope, message) => _data(_scope[0], message));
