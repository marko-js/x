...
const _renderer = _register((input, _tagVar, _scope0_) => {
  ...
  for (const val of arr) {
    ...
    _writeHydrateScope(_scope4_id, (_s3 => (_scope4_.set(i, _s3), _s3))({
      [_SYMBOL_OWNER]: _scope0_id
    }));
    _maybeFlush();
  }
  ...
  for (const val of list) {
    ...
    _writeHydrateScope(_scope5_id, (_s4 => (_scope5_.set(i, _s4), _s4))({
      [_SYMBOL_OWNER]: _scope0_id
    }));
    _maybeFlush();
  }
  ...
  for (const key in obj) {
    ...
    _writeHydrateScope(_scope6_id, (_s5 => (_scope6_.set(key, _s5), _s5))({
      [_SYMBOL_OWNER]: _scope0_id
    }));
    _maybeFlush();
  }
